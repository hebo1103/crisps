package net.crisps.cloud.framework.concurrent.wrapper;

import net.crisps.cloud.framework.concurrent.callback.DefaultCallback;
import net.crisps.cloud.framework.concurrent.callback.ICallback;
import net.crisps.cloud.framework.concurrent.callback.IWorker;
import net.crisps.cloud.framework.concurrent.exception.SkippedException;
import net.crisps.cloud.framework.concurrent.executor.timer.SystemClock;
import net.crisps.cloud.framework.concurrent.worker.DependWrapper;
import net.crisps.cloud.framework.concurrent.worker.ResultState;
